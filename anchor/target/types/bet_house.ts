  ...
  instructions: [
    {
      ...
      discriminator: [41, 11, 239, 155, 252, 7, 124, 205]
      accounts: [
        {
          name: 'poolAccount'
          writable: true
    ...
    {
      name: 'placeBet'
      docs: ['Users place a bet by transferring tokens to the contract pool.']
    ...
    {
      name: 'resolveBet'
      docs: ['Resolves a bet, transferring a reward to the user if they win.']
